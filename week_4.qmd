...
```{r}
myData <- read_excel("data_week_4/Ch7_Q15_Data_File.xlsx")
View(myData)
```
...
```{r}
myData <- read_excel("data_week_4/Ch7_Q25_Data_File.xlsx")
View(myData)
```
...
```{r}
myData <- read_excel("data_week_4/Ch9_Q13_Data_File.xlsx")
View(myData)
```
...
```{r}
myData <- read_excel("data_week_4/Ch9_Q21_Data_File.xlsx")
View(myData)
```
